...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF063559);
  late Color secondary = const Color(0xFF0D8C7F);
  late Color tertiary = const Color(0xFFEDD25B);
  late Color alternate = const Color(0xFF99BE5D);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0xFF666666);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFF063559);
  late Color accent1 = const Color(0xFF0D8C7F);
  ...
  late Color success = const Color(0xFF0D8C7F);
  late Color warning = const Color(0xFFFFF275);
  late Color error = const Color(0xFFED474A);
